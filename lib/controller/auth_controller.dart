...
Future<User2?> login(Map<String, String> body) async {
  print('1');
  try {
...
Future<User2?> registerUser(String email, String password, String passwordCof, String name) async {
  ...
  try {
    ...
    if (response.statusCode == 201) {
      ...
      if (responseData.containsKey('user') && responseData.containsKey('token')) {
        final User2 user = userFromJson(json.encode(responseData['user']));
